...
#define PCD_CALCCRC     0x03    // Calculate CRC (provjera ispravnosti podataka u transkacijama RC522 - kartica
...
#define Status1Reg       0x07   // Pokazuje status RFID-a / npr. je li RFID spreman za rad
#define Status2Reg       0x08
#define FIFODataReg      0x09   // FIFODataReg je registar kroz koji se šalju i primaju podaci između STM32 i RFID čitača
